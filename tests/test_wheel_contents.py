...
hatchling picks it up via ``packages = ["src/sim_plugin_pandapower"]``
...
def test_wheel_contains_skills(tmp_path: Path) -> None:
    ...
    wheels = list(out_dir.glob("sim_plugin_pandapower-*.whl"))
    ...
    required = {
        "sim_plugin_pandapower/__init__.py",
        "sim_plugin_pandapower/driver.py",
        "sim_plugin_pandapower/_skills/pandapower/SKILL.md",
    }
